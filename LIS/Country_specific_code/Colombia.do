**********************
* COLOMBIA brand new calculations
**********************
***DEFINE 3 PROGRAMS: 
    ...
    foreach ctry in $datasets {
		...
		*** merge
		 ...
		 *** recode 
			 ...
			 gen region = substr(region2, 6, 200) 
			 drop region2
// 			 decode ethnic_c, gen(ethnicity2)
// 			 gen ethnicity = substr(ethnicity2, 4, 300)
// 			 drop ethnicity2
		 ...
		 *** keep vars
			 keep hid pid dname cname hwgt pwgt ppopwgt region sex location illiterate wealth edyrs educ educ_c enroll age
...
program define doeduc
	...
	*** Edu info: updated
		* Primary
		...
		local primarydur = 5
		* Lower secondary
		local lowersecondaryage0 = 11
		local lowersecondaryage1 = 14
		local lowersecondaryfirst = 6 
		local lowersecondarylast = 10
		local lowersecondarydur = 4
		* Upper secondary
		local uppersecondaryage0 = 15
		local uppersecondaryage1 = 17
		local uppersecondaryfirst = 11
		local uppersecondarylast = 12
		local uppersecondarydur = 2
	...
	*** Temp vars ind 
		* Never 
		recode educ_c (0=1) (10/53=0), gen(never_prim_temp)	
		* Enrol
		recode enroll (1=1) (0=0), gen(enrolment) 	
		* Comp
		recode educ_c (0/24=0) (25/53=1), gen(comp_prim_temp)
		recode educ_c (0/33=0) (34/53=1), gen(comp_lowsec_temp) 
		recode educ_c (0/41=0) (42/53=1), gen(comp_upsec_temp) 
		recode educ_c (0/42=0) (51/53=1), gen(comp_higher_temp) 
	...
	*** Keep vars
		keep cname hwgt pwgt ppopwgt region sex wealth location ///
		eduyears_2024 edu0_prim edu_out_pry edu_out_lowsec edu_out_upsec ///
		comp_prim comp_prim_1524 comp_lowsec comp_lowsec_1524 comp_upsec comp_upsec_2029 comp_higher_2529 literacy_1524
