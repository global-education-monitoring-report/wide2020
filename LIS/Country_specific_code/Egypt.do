...
// 			 drop ethnicity2
		 ...
		 *** keep vars
			 keep hid pid dname cname hwgt pwgt ppopwgt region sex illiterate location wealth edyrs educ educlev educ_c enroll age
...
program define doeduc
	...
	*** Temp vars ind 
		* Never 
		recode educlev (111=1) (110 120/313=0), gen(never_prim_temp)	
		* Enrol
		recode enroll (1=1) (0=0), gen(enrolment) 	
		* Comp
		recode educlev (110 111=0) (120/313=1), gen(comp_prim_temp)
		recode educlev (110/120=0) (130/313=1), gen(comp_lowsec_temp) 
		recode educlev (110/130=0) (210/313=1), gen(comp_upsec_temp) 
		recode educlev (110/210=0) (220/313=1), gen(comp_higher_temp) 
