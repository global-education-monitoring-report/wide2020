**********************
* PALESTINE brand new calculations
**********************
***DEFINE 3 PROGRAMS: 
...
program define doeduc
	...
	*** Edu info: updated 
		* Primary
		...
		local primarydur = 4
		* Lower secondary
		local lowersecondaryage0 = 10
		local lowersecondaryage1 = 15
		local lowersecondaryfirst = 5 
		local lowersecondarylast = 10
		local lowersecondarydur = 6
		* Upper secondary
		local uppersecondaryage0 = 16
