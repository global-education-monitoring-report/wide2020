...
dhs_read $data_path  $data_path/temporal $data_path/all $aux_data_path/dhs_dictionary.csv $aux_data_path/dhs_renamevars.csv

* alternative: if data is stored in different foldes 

dhs_read $data_path/Part1 $data_path/temporal/Part1 $data_path/all/Part1 $aux_data_path/dhs_dictionary.csv $aux_data_path/dhs_renamevars.csv

dhs_read $data_path/Part2 $data_path/temporal/Part2 $data_path/all/Part2 $aux_data_path/dhs_dictionary.csv $aux_data_path/dhs_renamevars.csv



* CLEANING THE DATASET (RECODING SEVERAL VARIABLES)

dhs_clean $data_path/all/dhs_reading.dta $aux_data_path $aux_data_uis/duration_age/UIS_duration_age_25072018.dta $data_path/all/dhs_cleaning.dta

* alternative: if data is stored in different foldes 

dhs_clean $data_path/all/Part1/dhs_reading.dta $aux_data_path $aux_data_uis/duration_age/UIS_duration_age_25072018.dta $data_path/all/Part1/dhs_cleaning.dta

dhs_clean $data_path/all/Part2/dhs_reading.dta $aux_data_path $aux_data_uis/duration_age/UIS_duration_age_25072018.dta $data_path/all/Part2/dhs_cleaning.dta
