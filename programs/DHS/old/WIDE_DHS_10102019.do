...
for X in 1 2: cap mkdir "$data_dhs\PR\countries\\partX"
...
keep if year>=2015
order iso_code3 country_year country year year_folder 
compress
...
*Attendance
recode hv121 (1/2=1) (8/9=.), gen(attend_curr)
tab hv122 hv121, m
replace attend_curr=1 if hv121==0 & hv122==0 // those in preschool (diff for oos)
replace attend_curr=. if hv122==. & (hv121==1|hv121==2|hv121==8|hv121==.)
...
for X in any preschool primary secondary higher: gen attend_curr_X=0 if attend_curr==1
replace attend_curr_preschool =1 if hv122==0 & attend_curr_preschool ==0 
replace attend_curr_primary   =1 if hv122==1 & attend_curr_primary   ==0 
replace attend_curr_secondary =1 if hv122==2 & attend_curr_secondary ==0
replace attend_curr_higher    =1 if hv122==3 & attend_curr_higher    ==0
for X in any preschool primary secondary higher: replace attend_curr_X=. if (attend_curr==.|hv122==.)
