...
drop edu0_prim1
drop *age0* *age1*
order iso country* year* *weight *id cluster age* adjustment location sex wealth eduyear* comp* attend* eduout*
compress
*save "\\hqfs\tech\STATA\WIDE\microdata_Bilal\DHS_Microdata.dta", replace // this is the database I sent to Bilal
*save "C:\Users\Rosa_V\Desktop\WIDE\WIDE\microdata_bilal\microdata_DHS.dta", replace // this is the database I sent to Bilal
save "C:\Users\Rosa_V\Dropbox\microdata_Bilal\microdata_DHS.dta", replace
