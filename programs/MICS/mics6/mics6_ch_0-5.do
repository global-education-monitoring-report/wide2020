...
global list2 litnum physical socioem learns ecd



******************************************************************************************************
******************************************************************************************************
foreach country in Iraq KyrgyzRepublic LaoPDR SierraLeone Suriname Tunisia TheGambia {
 use "C:\Users\Rosa_V\Desktop\WIDE\Data\MICS\\`country'\ch.dta", clear
 include "C:\Users\Rosa_V\Desktop\WIDE\WIDE\WIDE_MICS\programs\auxiliary\mics6_standardizes_ch"
 gen country="`country'"
 compress
 save "C:\Users\Rosa_V\Desktop\WIDE\WIDE\WIDE_MICS\data\mics6\ch\\`country'.dta", replace
}

 ****************************************************************************************
 ****************************************************************************************
 
cd "C:\Users\Rosa_V\Desktop\WIDE\WIDE\WIDE_MICS\data\mics6\ch\" 
 use Iraq.dta, clear
 ...
 save "C:\Users\Rosa_V\Desktop\WIDE\WIDE\WIDE_MICS\data\mics6\ch_module.dta", replace

**********

use "C:\Users\Rosa_V\Desktop\WIDE\WIDE\WIDE_MICS\data\mics6\ch_module.dta", clear
collapse (mean) $list2 if cage>=36 & cage<=59 [iw=chweight], by(country year)
