...
foreach var of varlist ed3 ed4a ed4b ed5 ed6a ed6b ed7 ed8a {
	...
	replace `var' = "missing" if (`var'=="em falta"|`var'=="manquant"|`var'=="omitido"|`var'=="no reportado"|`var'=="non declaree")
...
foreach var of varlist code_ed4a code_ed6a code_ed8a {
	...
	*Added 24 Feb 2020
	recode `var' (2=21) (3=22) (4=3) if (country_year=="Congo_2015")
	recode `var' (2=21) (3=22) (4/5=33) (6=3) if (country_year=="Guinea_2016")
}
...
*Changes according to UIS (agreed with Bilal)
	...
	for X in any 4 6 8: replace code_edXa=33 if edXa_nr==4 &(edXb_nr==4|edXb_nr==5) & country_year=="Iraq_2011" // check bc it doesn't create any changes
...
for X in any ed4a ed6a ed8a: tab X, m	
...
*--1d) STAIRS UNTIL SECONDARY + FLAT FOR HIGHER onwards (has info on years higher)

foreach country_year in Guinea_2016 Jamaica_2011 Kazakhstan_2015 SaoTomeandPrincipe_2014 {
	*Stairs for higher
...
foreach country_year in Algeria_2012 Bangladesh_2013 Barbados_2012 Belize_2011 Belize_2015 Benin_2014 BosniaandHerzegovina_2011 ///
	Chad_2010 Congo_2015 CostaRica_2011 CotedIvoire_2016 Cuba_2010 Cuba_2014 DominicanRepublic_2014 DRCongo_2010 ///
...
*Case: Bhutan 2010 (according to labels)
	replace code_ed4a=3 if (ed4b_label=="bachelor"|ed4b_label=="diploma") & country_year=="Bhutan_2010" // Check: doesn't create changes
...
save "C:\Users\Rosa_V\Dropbox\microdata_Bilal\microdata_MICS4&5.dta", replace
