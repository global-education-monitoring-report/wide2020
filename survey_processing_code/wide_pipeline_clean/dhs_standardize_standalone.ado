* dhs_standardize: program to intake raw DHS surveys and standardize years of education, education completion and education out of school rates
* Version 4.0
* May 2021
...
* Update 7/jul/2023: nothing new really, just adapted to the new laptop 
...
// 	}
	...
	*Durations for out-of-school
	...
	capture confirm variable ecd
								if !_rc {
	keep country_year year age* iso_code3 hv007 sex location wealth religion ethnicity hhweight region comp_* eduout* attend* literacy cluster prim_dur lowsec_dur upsec_dur prim_age* lowsec_age* upsec_age* hh* hvidx individual_id attend round adjustment edu* hh* hv101 hv122 hv123 hv124 years_* ecd*  `disabilityvars' hv112
								}
								else {
	keep country_year year age* iso_code3 hv007 sex location wealth religion ethnicity hhweight region comp_* eduout* attend* literacy cluster prim_dur lowsec_dur upsec_dur prim_age* lowsec_age* upsec_age* hh* hvidx individual_id attend round adjustment edu* hh* hv101 hv122 hv123 hv124 years_*  `disabilityvars' hv112
								}
	...
	**Some additional calculations for Bilal
	...
	foreach Z in prim lowsec upsec higher {
		...
		tab  hh_edu_adult_`Z' hh_edu_adult_exact
				 	}
	...
	*Fix year variable hh5y in case some of the imports contain weird values (special cases of Nepal and Ethiopia)
	capture replace hh5y = year_folder if  (hh5y - year_folder) > 3
	capture replace year = year_folder if  (year - year_folder) > 3
