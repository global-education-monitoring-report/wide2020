...
for (i in 2:length(folder_names)) {
  survey <- substring( folder_names[[i]], 50, 65)
  ...
  source("C:/Users/mm_barrios-rivera/Documents/GEM UNESCO MBR/GitHub/wide2020/survey_processing_code/wide_pipeline_clean/wide_calculate.R")
  }
