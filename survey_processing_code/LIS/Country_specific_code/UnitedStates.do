...
program define domerge
    foreach ctry in $datasets {
		...
		*** merge
		 ...
		 *** keep vars
			 keep hid pid dname cname hwgt pwgt ppopwgt region sex ethnicity wealth edyrs educ educ_c enroll age
...
program define doeduc
	...
	*** Temp vars ind 
		* Never 
		recode educ_c (31=1) (32/46=0), gen(never_prim_temp)	
		* Enrol
		recode enroll (110 120=1) (200=0), gen(enrolment) 	
		* Comp
		recode educ_c (31/33=0) (34/46=1), gen(comp_prim_temp)
		recode educ_c (31/34=0) (35/46=1), gen(comp_lowsec_temp) 
		recode educ_c (31/38=0) (39/46=1), gen(comp_upsec_temp) 
		recode educ_c (31/41=0) (42/46=1), gen(comp_higher_temp) 
	...
	*** Keep vars
		keep cname hwgt pwgt ppopwgt region sex ethnicity wealth ///
...
program define doedumean
   ...
   ***  Global
	...
	*** 1d
   di "---- 1d ----"	
        foreach x in  sex wealth region ethnicity  {
		   di "----`x'----"	
	...
	*** 2d 
global categories_collapse sex wealth region ethnicity 
...
*Not running well because of too many combinations with ethnicity
 *** 3d 
 global categories_collapse sex wealth region ethnicity 
 tuples $categories_collapse, display
 display "`tuple`i''"
...
global varsp "hid pid dname cname pwgt ppopwgt age sex educ ethnic_c edyrs educ_c educlev enroll"
domerge
doeduc	
