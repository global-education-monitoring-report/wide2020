...
replace region="." if region=="Missing"|region=="missing"

* Location
codebook urban16
decode urban16, gen(location)
replace location="." if location=="Missing"



* Ethnicity
codebook pa701code,tab(200)
g ethnicity = "Han" if pa701code==1
replace ethnicity = "Other" if (pa701code>1 & pa701code<.) 
tab ethnicity  // ? few observations!! (only 10% of the sample)
...
enerate lowsec_age0_eduout = prim_age0_eduout + prim_dur
