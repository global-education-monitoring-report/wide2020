...
clear
import delimited "C:\Users\taiku\Documents\GEM UNESCO MBR\Datasets to update WIDE\Other surveys\Argentina\usu_hogar_t119.txt", encoding(ISO-8859-2) 
...
clear
import delimited "C:\Users\taiku\Documents\GEM UNESCO MBR\Datasets to update WIDE\Other surveys\Argentina\Usu_hogar_T319.txt", encoding(ISO-8859-2) 
save it3.dta, replace
clear
import delimited "C:\Users\taiku\Documents\GEM UNESCO MBR\Datasets to update WIDE\Other surveys\Argentina\usu_hogar_T419.txt", encoding(ISO-8859-2) 
...
order iso_code2 iso_code3 country survey year country_year category Region Wealth Sex  
