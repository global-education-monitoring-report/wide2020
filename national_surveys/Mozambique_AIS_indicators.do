...
local highestlevelattended hv106 

recode `highestlevelattended' (8=.) , gen(highestlevelattended)
*fix for upper and lowsec detail
replace highestlevelattended=3 if inlist(hv122, 2) & inlist(hv123 , 10, 11, 12)
replace highestlevelattended=3 if inlist(hv106, 2) & inlist(sh17b , 10, 11, 12)
