* dhs_summarize: program to summarize the DHS indicators
* Version 3.0
* January 2020
* changed macro varlists to include extra indicators 
...
program define dhs_summarize
	...
	* mean estimation 
	foreach i of numlist 0/6 12/18 20/21 31 41 {
		...
		set more off
		gcollapse (mean) `varlist_m' [aw = hhweight], by(`varsby' `tuple`i'') fast
