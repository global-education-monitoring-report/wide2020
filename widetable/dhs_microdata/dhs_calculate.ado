	...
	*generate eduyears_2024 = eduyears if agestandard >= 20 & agestandard <= 24
	foreach X in 2 4 {
		generate edu`X'_2024 = 0
			replace edu`X'_2024 = 1 if eduyears < `X'
			replace edu`X'_2024 = . if eduyears == .
	}
	*******LESS THAN 2/4 YEARS OF SCHOOLING**********
...
// 	drop attend_higher
	...
	*New
	gen comp_higher_2yrs = 1 if eduyears >= years_upsec + 2
	gen comp_higher_4yrs = 1 if eduyears >= years_upsec + 4
	...
	*******NOTE ON PRE-SCHOOL EDUCATION ATTENDANCE: there's no preschool in hv106, its mixed with no school...**********

	rename hv007 year_interview
	
	drop hv008 hv009 hv016 hv102 hv106 hv107 hv108 hv109 hv121 hv122 hv123 hv124 hv125 hv126 hv127 hv128 hv129 hvidx message
	order iso_code3 country_name_dhs cluster hhid hv000 hv002 hv003 sex wealth location region location ethnicity religion comp_prim comp_lowsec comp_upsec attend eduout agestandard comp_prim_v2 comp_lowsec_v2 comp_upsec_v2 comp_prim_aux comp_lowsec_aux eduyears edu2_2024 edu4_2024 edu0_prim1 attend_higher lowsec_age0_eduout upsec_age0_eduout prim_age1_eduout lowsec_age1_eduout upsec_age1_eduout eduout_prim eduout_lowsec eduout_upsec comp_higher_2yrs comp_higher_4yrs literacy_1549
