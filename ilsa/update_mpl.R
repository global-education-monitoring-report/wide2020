...
pisa_r <- ilsa_sum(pvnames = "READ", 
                     cutoff = c(262.04, 407.47, 480.18, 552.89),
                     config = pisa_conf,
                     data = pisa,
                     year = 2018,
...
dir <- "/home/eldani/MEGA/Work/Projects/Ongoing/UNESCO/Analysis/ILSA"
write.csv(wide_data, row.names = FALSE, na="", file = file.path(dir, "update_mpl.csv"))
